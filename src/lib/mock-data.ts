...
export const mockServices: MockService[] = [
  ...
  },
  {
    ...
    name: "ถ่ายอีเวนต์",
    slug: "event",
    description: "คอนเสิร์ต งานเปิดตัว งานประชุม งานเลี้ยง งานฮารีรายอ — ปรับแสงสีสวยทุกภาพ ถ่ายได้ไม่จำกัด ส่งงานไว",
    image: portfolioPhotos.event1,
    basePrice: 500,
    deposit: 500,
    durationMinutes: 60,
    tags: ["ปรับแสงสีสวยทุกภาพ", "ถ่ายได้ไม่จำกัด", "ส่งรูปภาพไม่เกิน 3 วัน"],
...
export const mockPackages: MockPackage[] = [
  ...
  },
  {
    id: "pkg-evt-1",
    serviceSlug: "event",
    name: "อีเวนต์งานเล็ก (ครึ่งวัน)",
    description: "ครึ่งวัน ปรับแสงสีสวยทุกภาพ ถ่ายได้ไม่จำกัด ส่งรูปภาพไม่เกิน 3 วัน",
    price: 3500,
    deposit: 1000,
    durationMinutes: 240,
    deliverables: [
  ...
  },
  {
    ...
    serviceSlug: "event",
    name: "อีเวนต์งานใหญ่",
    description: "เต็มวัน ปรับแสงสีสวยทุกภาพ ถ่ายได้ไม่จำกัด ส่งรูปภาพไม่เกิน 3 วัน",
    price: 6000,
    deposit: 1500,
    durationMinutes: 480,
    deliverables: [
  ...
  },
  {
    id: "pkg-evt-3",
    serviceSlug: "event",
    name: "งานอีเวนต์ ฮารีรายอ (บ้านนี้มีรัก)",
    description: "คิดเป็น ชั่วโมงละ 500 บาท ถ่ายรูปไม่จำกัด ปรับแสงสีสวยทุกรูป แถมวิดิโอ 1-2 นาที ได้ 1 คลิป",
    price: 500,
    deposit: 500,
    durationMinutes: 60,
    deliverables: [
      "คิดเป็น ชั่วโมงละ 500 บาท",
      "ถ่ายรูปไม่จำกัด",
      "ปรับแสงสีสวยทุกรูป",
      "แถมวิดิโอ 1-2 นาที ได้ 1 คลิป",
    ],
  },
];
...
export const mockBookings: MockBooking[] = [
  ...
  { id: "bk-4", code: "JN2P6H8D", customerName: "บอส ปรเมศร์", phone: "089-444-5566", serviceName: "ถ่ายอีเวนต์", packageName: "อีเวนต์งานเล็ก (ครึ่งวัน)", date: "2026-08-18", startTime: "13:00", endTime: "17:00", status: "confirmed", paymentStatus: "verified", deposit: 1000, remaining: 2500, source: "tiktok", photographer: "พี่มิกซ์" },
  ...
  { id: "bk-9", code: "JN6C2F5P", customerName: "โอม ชลสิทธิ์", phone: "089-999-0011", serviceName: "ถ่ายอีเวนต์", packageName: "อีเวนต์งานใหญ่", date: "2026-09-12", startTime: "09:00", endTime: "13:00", status: "pending_payment", paymentStatus: "pending", deposit: 1500, remaining: 4500, source: "direct", photographer: "พี่มิกซ์" },
