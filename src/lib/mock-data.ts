...
export const mockPackages: MockPackage[] = [
  ...
  },
  {
    ...
    name: "แพ็กเกจเดี่ยว",
    description: "ถ่ายชุดเดี่ยว ครุย + ชุดไทย",
    price: 1800,
    deposit: 500,
    durationMinutes: 60,
    deliverables: ["ไฟล์แต่งสี 20 รูป", "ปริ้นท์ 4x6 จำนวน 10 ใบ"],
  },
  {
    id: "pkg-grad-2",
    serviceSlug: "graduation",
    name: "แพ็กเกจครอบครัว",
    description: "ถ่ายกับครอบครัว + เพื่อนไม่จำกัดชุด",
    price: 3500,
    deposit: 500,
    durationMinutes: 120,
    deliverables: ["ไฟล์แต่งสี 60 รูป", "ปริ้นท์ 4x6 ชุดใหญ่", "กรอบรูป 8x10"],
    popular: true,
  },
  {
    id: "pkg-grad-3",
    serviceSlug: "graduation",
    name: "แพ็กเกจ VIP",
    description: "ครบทุกชุด ทั้งในสตูดิโอและนอกสถานที่",
    price: 6000,
    deposit: 500,
    durationMinutes: 240,
    deliverables: ["ไฟล์แต่งสี 150 รูป", "อัลบั้ม 8x8", "กรอบรูป 2 ชิ้น"],
  },
  {
    id: "pkg-port-1",
